...
```{r}
library(leaps)
best <- regsubsets(bcPower(PriceinGermany, p1$roundlam) ~ BatterySize + Acceleration + TopSpeed + Range + Efficiency + FastChargeSpeed + NumberofSeats, data = ev_numeric, nbest = 2, method = "exhaustive")
